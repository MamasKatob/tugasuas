...
pindah folder mahasiswa beserta file di dalamnya ke folder xampp htdocs.
buat database dengan nama crud_db.sql, dan export file database di folder database.
